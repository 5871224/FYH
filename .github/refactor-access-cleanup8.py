...
path = Path('scripts/check-renderer-alignment.js')
path.write_text(r'''const fs = require("node:fs");
...
''', encoding='utf-8')
print('renderer alignment guard rewritten for canonical access architecture')
