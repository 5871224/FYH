...
assert(renderer.includes("function buildAutoSchedulePreview(dates = getVisibleDates(), options = {})"), "auto schedule preview should accept an explicit date range and options");
...
assert(renderer.includes("markAutoSchedulePart(slot, \"shift\")"), "auto schedule should mark generated shifts");
assert(renderer.includes("markAutoSchedulePart(slot, \"leave\")"), "auto schedule should mark generated leave");
assert(renderer.includes("resetAutoGenerated: true"), "reschedule should clear previous auto-generated results before rebuilding");
